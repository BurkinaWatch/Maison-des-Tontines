...
export class TontinesController {
  ...
  async createTontine(req: any, res: Response, next: NextFunction) {
    try {
  ...
  async getTontines(req: any, res: Response, next: NextFunction) {
    try {
      const userId = req.userId!;
  ...
  async getTontine(req: any, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
      const userId = req.userId!;
  ...
  async updateTontine(req: any, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
      const data = req.body;
